function ready(){
    jQuery(document).ready(function(){
        ...
        jQuery(function () {
            function mmenuInit() {
                ...
                if (wi <= '1099') {
                    ...
                    var jQueryicon = jQuery(".mmenu-trigger .hamburger");

                    jQuery(".mmenu-trigger").on('click', function () {
                        mmenuAPI.open();
                    });
        ...
        /*  Slick Carousel
        /*----------------------------------------------------*/
        // jQuery('.default-slick-carousel').slick('unslick')

        if(jQuery('.slick-list').length > 0){
            Query('.default-slick-carousel').slick('unslick')
        }
