                        ...
                        {{
                          course.units.reduce(
                            (previousValue, currentValue) =>
                              previousValue  + currentValue.lectures.length,
                            0
                          )
                        }}
                      </li>
        ...
        <div class="sidebar-container">
          ...
          <div class="profile-overview">
            <div class="overview-item">
              <strong>البريد الإلكتروني</strong><span>{{ user.email }}</span>
            </div>
            <div class="overview-item">
              <strong>الكورسات</strong><span>{{user.courses.length}}</span>
            </div>
            <div class="overview-item">
              <strong>الرصيد</strong><span>50 JOD</span>
            </div>
          </div>
          ...
          <a
            ...
            >Make an Offer <i class="icon-material-outline-arrow-right-alt"></i
          ></a>
          ...
          <div class="sidebar-widget">
            ...
            <div class="attachments-container">
              <a href="#" class="attachment-box ripple-effect"
                ><span>Cover Letter</span><i>PDF</i></a
              >
              <a href="#" class="attachment-box ripple-effect"
                ><span>Contract</span><i>DOCX</i></a
              >
            </div>
          </div>
